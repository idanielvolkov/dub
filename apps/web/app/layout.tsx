        ...
        <Script id="recover-stale-client-bundle" strategy="beforeInteractive">
          ...
          (() => {
            ...
            const isStaleBundleError = (value) => {
              ...
              return /ChunkLoadError|Loading chunk|Failed to fetch dynamically imported module|Importing a module script failed|module script.*failed|CSS_CHUNK_LOAD_FAILED|Minified React error #130|Element type is invalid|history\.replaceState\(\) more than 100 times|Attempt to use history\.replaceState/i.test(message);
            };
